...
-- end
---@class TornadoDebug
---@version 1.5 (POS TRACKER + WARNINGS)
---@description Added specific flag for position tracking to reduce console spam, plus warning/error methods.
...
function TornadoDebug:warning(tag, msg)
    print(string.format("[%s WARNING] %s", tag, msg))
end

function TornadoDebug:error(tag, msg)
    print(string.format("[%s ERROR] %s", tag, msg))
end
